      ...
      {isOpen ? (
        ...
        >
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            <motion.a href="https://github.com/ryuuDre" target={"_blank"} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 mr-3 sm:mx-1 bg-light rounded-full dark:bg-dark">
              <GithubIcon />
            </motion.a>
            ...
            <motion.a href="https://www.instagram.com/ryuu.dre/" target={"_blank"} whileHover={{ y: -2 }} whileTap={{ scale: 0.9 }} className="w-6 ml-3 sm:mx-1">
              <InstagramIcon />
            </motion.a>
